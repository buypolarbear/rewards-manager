...
/**
 * Provides Base32 encoding and decoding almost compatible with the encoding
 * defined by <a href="http://www.ietf.org/rfc/rfc4648.txt">RFC 4648</a>. Using
 * this implementations is possible to use a different padding character for
 * Base32 that is compatible with QRCode alphanumeric encoding format
 * 
 * <p>
 ...
 */
public class QRCodeCompatibleBase32Encoder extends BaseNCodec {

	public static final byte QRCODE_COMPATIBLE_DEFAULT_PAD = '%';
	 ...
	 * from the "Base32 Alphabet" (as specified in Table 3 of RFC 4648) into
	...
	/**
	 * This array is a lookup table that translates Unicode characters drawn
	 * from the "Base32 |Hex Alphabet" (as specified in Table 3 of RFC 4648)
	 ...
	 * 
	 */
	public QRCodeCompatibleBase32Encoder() {
		this(false);
	}
	 ...
	 */
	public QRCodeCompatibleBase32Encoder(final boolean useHex) {
		this(0, null, useHex);
	}
	 ...
	 *            (rounded down to nearest multiple of 8). If lineLength &lt;=
	 *            0, then the output will not be divided into lines (chunks).
	 *            Ignored when decoding.
	 */
	public QRCodeCompatibleBase32Encoder(final int lineLength) {
	 ...
	 */
	public QRCodeCompatibleBase32Encoder(final int lineLength,
			final byte[] lineSeparator, final boolean useHex) {
		super(BYTES_PER_UNENCODED_BLOCK, BYTES_PER_ENCODED_BLOCK, lineLength,
				lineSeparator == null ? 0 : lineSeparator.length,
				QRCODE_COMPATIBLE_DEFAULT_PAD);
		if (useHex) {
